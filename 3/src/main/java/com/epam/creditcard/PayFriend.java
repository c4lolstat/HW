 ...
 */
@Component
public class PayFriend implements Payable {

    private static final Logger LOGGER = LoggerFactory.getLogger(PayFriend.class);
    private final String HOST = "http://localhost:8087";
