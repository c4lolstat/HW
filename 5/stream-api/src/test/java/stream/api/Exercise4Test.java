...
public class Exercise4Test extends ClassicOnlineStore {
    ...
    public void isThereAnyoneOlderThan40() {
        ...
        Predicate<Customer> predicate = c -> c.getAge() > 40;
        boolean olderThan40Exists = customerList.stream().anyMatch(predicate);
    ...
    public void isEverybodyOlderThan20() {
         ...
         */
        Predicate<Customer> predicate = c -> c.getAge() > 20;
        boolean allOlderThan20 = customerList.stream().anyMatch(predicate);
    ...
    public void everyoneWantsSomething() {
         ...
         */
        Predicate<Customer> predicate = c -> c.getWantToBuy().isEmpty();
        boolean everyoneWantsSomething = customerList.stream().noneMatch(predicate);
