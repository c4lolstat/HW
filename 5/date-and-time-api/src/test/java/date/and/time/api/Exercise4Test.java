...
public class Exercise4Test {
    ...
    public void zonedDateTimeOf() {
        ...
        ZonedDateTime zonedDateTime = ZonedDateTime.of(2015,7,10,2,14,25,0, id);
    ...
    public void zonedDateTimeFormat() {
         ...
         */
        DateTimeFormatter pattern = DateTimeFormatter.ofPattern("uuuu_MM_dd_HH_mm_ss_z");
        String strZdt = zdt.format(pattern);
    ...
    public void sameInstantAs() {
         ...
         */
        ZoneId id = ZoneId.of("America/Los_Angeles");
        ZonedDateTime zonedDateTime = zdt.withZoneSameInstant(id);
    ...
    public void sameLocalAs() {
         ...
         */
        ZoneId id = ZoneId.of("America/Los_Angeles");
        ZonedDateTime zonedDateTime = zdt.withZoneSameLocal(id);
